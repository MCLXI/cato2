                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Catocoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About Catocoin Core"));
...
cursor.insertText("1	2,000	1.21");cursor.insertBlock();
...
cursor.insertText("15	2,000	3.60");cursor.insertBlock();
cursor.insertText("20	2,000	4.05");cursor.insertBlock();
...
cursor.insertText("Locked coins do not stake");cursor.insertBlock();
cursor.insertText("30 confirmations required");cursor.insertBlock();
cursor.insertText("Coins need to mature for 6 hours before staking");cursor.insertBlock();
cursor.insertText("Masternodes do not earn rewards until 6 hours after start");cursor.insertBlock();
        cursor.insertBlock();
        cursor.insertBlock();
        cursor.insertBlock();
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Catocoin Core is shutting down...") + "<br /><br />" +
