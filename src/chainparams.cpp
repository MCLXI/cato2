...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 33888;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Catocoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 45; // Catocoin: 1 day
        nTargetSpacing = 2 * 45; //Catocoin: 1 minute
        nMaturity = 90;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Catocoin is born from the ashes. 5/20/2018";
